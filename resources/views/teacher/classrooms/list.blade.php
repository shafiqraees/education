                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-actions"> <a href="{{ route('create.class.room')}}" class="btn btn-social btn-dark btn-dark text-center mt-1 pr-1"> <span class="la la-plus font-medium-3"></span> Add New Class Room</a> </div>
                                        </div>
                                    </div>
                                    <br>
                                                                ...
                                                                @if(!empty($data))
                                                                    @foreach($data as $row)
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="{{route('edit.class.room',$row->id)}}" class="btn btn-icon bg-dark white" data-toggle="tooltip" data-placement="top" title="" data-original-title="edit"><i class="la la-pencil"></i></a>
                                                                                <a href="javascript:void(0)" class="btn btn-icon bg-dark white classroom" data-id="{{$row->id}}" data-url="{{route('delete.class.room')}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="delete"><i class="la la-trash"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                                                @endif
