    ...
    <div class="app-content content">
        <div class="content-wrapper">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('all.class.room')}}">Class Rooms</a> </li>
            ...
            <div class="content-body">
                <form class="form-horizontal" id="formsss" method="post" action="{{route('save.class.room')}}" name="specifycontent" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="card box-shadow-0 border-dark">
                                    <div class="card-header card-head-inverse bg-dark">
                                        <h4 class="card-title text-white">Create Class Room</h4>
                                    </div>
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            <fieldset class="form-group row">
                                                ...
                                                <div class="col-md-6 mt-1">
                                                    <label class="inline-
                                                    block" for="sel1">Class Code</label>
                                                    <input type="text" name="class_code" class="form-control heightinputs " id="basicInput" required>
                                                </div>
                                                <div class="col-md-6 mt-1">
