                        ...
                        <div class="card pull-up">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-left">
                                            <h3 class="amber">{{isset($last_24Hours_Teacher) ? $last_24Hours_Teacher : ""}}</h3>
                                            <h6>Teacher</h6>
                                        </div>
                                        <div>
                                            <h5 class="amber">24 Hours</h5>
                        ...
                        <div class="card pull-up">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-left">
                                            <h3 class="red">{{isset($last_7_Days_Teacher) ? $last_7_Days_Teacher : ""}}</h3>
                                            <h6>Teacher</h6>
                                        </div>
                                        <div>
                                            <h5 class="red">7 Days</h5>
                        ...
                        <div class="card pull-up">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-left">
                                            <h3 class="success">{{isset($life_Time_Teacher) ? $life_Time_Teacher : ""}}</h3>
                                            <h6>Teacher</h6>
                                        </div>
                                        <div>
                                            <h5 class="success">Lifetime</h5>
