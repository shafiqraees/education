    ...
    <div class="app-content content">
        <div class="content-wrapper">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('all.students')}}">Stdents</a> </li>
                                <li class="breadcrumb-item active">Stdent Create </li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-body">
                <form class="form-horizontal"id="quiz" name="quiz" method="post" action="{{route('save.student')}}"  enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="card box-shadow-0 border-dark">
                                    <div class="card-header card-head-inverse bg-dark">
                                        <h4 class="card-title text-white">Create Stdent</h4>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <fieldset class="form-group row" id="extrafileds">
                                                ...
                                                <div class="col-md-6 mt-1">
                                                    ...
                                                    <input type="text" name="roll_number" class="form-control heightinputs " id="basicInput" required>
                                                </div>
                                                <div class="col-md-6 mt-1">
                                                    ...
                                                    <select class="form-control" id="test_type" aria-invalid="false" name="class_room" required>
                                                        <option value="true">Select Calss Room</option>
                                                        @if(!empty($class))
